...
music:		PXL.o music.o $(LHAPDFDIR)/ccwrap/LHAPDFWrap.o $(LHAPDFDIR)/ccwrap/LHAPDFfw.o MISalgo/AnyOption.o TConfig/TConfigDict.o TConfig/TConfig.o ElectronID/LikelihoodEstimator.o ElectronID/ElectronLikelihood.o ElectronID/GammaLikelihood.o ParticleMatcher/ParticleMatcher.o ParticleMatcher/EventSelector.o  DuplicateObjects/DuplicateObjects.o
		$(CXX) -o music PXL.o music.o $(LHAPDFDIR)/ccwrap/LHAPDFWrap.o $(LHAPDFDIR)/ccwrap/LHAPDFfw.o MISalgo/AnyOption.o TConfig/TConfigDict.o TConfig/TConfig.o ElectronID/LikelihoodEstimator.o ElectronID/ElectronLikelihood.o ElectronID/GammaLikelihood.o ParticleMatcher/ParticleMatcher.o ParticleMatcher/EventSelector.o DuplicateObjects/DuplicateObjects.o $(LDFLAGS) -lz
