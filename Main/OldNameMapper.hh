...
class OldNameMapper {
    ...
    public:
       ...
       std::string getUserRecordName( const pxl::Particle* &obj, std::string partName, std::string variableName)const;
       std::string getUserRecordName( const pxl::Object* &obj, std::string partName, std::string variableName);
       std::string getUserRecordName( const pxl::Object* &obj, std::string variableName,
        ...
        void addReplacement( std::string partName, std::string variableName, std::string replacement);
